...
<section class="stats grid">
    <div class="stat card"><div class="stat-icon blue">&#128337;</div><div class="stat-body"><div class="stat-title">Required Hours</div><div class="stat-value">{{ $hourStats['required'] }} hours</div></div></div>
    <div class="stat card"><div class="stat-icon green">&#10003;</div><div class="stat-body"><div class="stat-title">Completed Hours</div><div class="stat-value green-text">{{ $hourStats['approved'] }} hours</div></div></div>
    <div class="stat card"><div class="stat-icon orange">&#128336;</div><div class="stat-body"><div class="stat-title">Pending Hours</div><div class="stat-value orange-text">{{ $hourStats['pending'] }} hours</div></div></div>
    <div class="stat card"><div class="stat-icon purple">&#9203;</div><div class="stat-body"><div class="stat-title">Remaining Hours</div><div class="stat-value purple-text">{{ $hourStats['remaining'] }} hours</div></div></div>
</section>
...
<section class="service-hours-grid">
    <div class="service-main">
        <div class="card">
            <div class="tabs">
                @foreach(['all' => 'All Records', 'approved' => 'Approved', 'pending' => 'Pending', 'rejected' => 'Rejected'] as $key => $label)
                    ...
                    <tbody>
                        @foreach($records as $rec)
                            <tr>
                                ...
                                <td>{{ $rec->hours_earned ? $rec->hours_earned . ' hrs' : '—' }}</td>
                                <td><span class="badge {{ $rec->status === 'approved' ? 'confirmed' : ($rec->status === 'rejected' ? 'rejected' : 'pending') }}">{{ ucfirst($rec->status) }}</span></td>
                                <td>{{ $rec->remarks ?? '—' }}</td>
        ...
        <div class="card how-it-works">
            ...
            <div class="steps-grid">
                ...
                <div class="step"><div class="step-num">2</div><div class="step-icon">&#128247;</div><strong>Check In / Out</strong><p>Log your attendance during the event.</p></div>
                <div class="step"><div class="step-num">3</div><div class="step-icon">&#128269;</div><strong>Verification</strong><p>Admin verifies your attendance record.</p></div>
